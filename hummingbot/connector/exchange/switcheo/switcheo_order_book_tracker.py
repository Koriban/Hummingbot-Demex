...
from hummingbot.connector.exchange.switcheo.switcheo_order_book_message import CryptoComOrderBookMessage
from hummingbot.connector.exchange.switcheo.switcheo_active_order_tracker import CryptoComActiveOrderTracker
from hummingbot.connector.exchange.switcheo.switcheo_api_order_book_data_source import SwitcheoAPIOrderBookDataSource
from hummingbot.connector.exchange.switcheo.switcheo_order_book import CryptoComOrderBook
...
class CryptoComOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self, trading_pairs: Optional[List[str]] = None,):
        super().__init__(SwitcheoAPIOrderBookDataSource(trading_pairs), trading_pairs)
